...
for i in range(5):
    ...
    plt.savefig(f"results/cart_pole_DDQN_{i+1}.jpg")     
    plt.close()

    with open(f'results/cart_pole_DDQN_rewards_{i+1}.csv', 'a', newline='') as file:
    ...
    model.save(f'data/model_DDQN_cart_pole_{i+1}.keras')
